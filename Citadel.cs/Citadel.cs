...
namespace WindowsGSM.Plugins
{
    public class Citadel : SteamCMDAgent
    {
        ...
        public Plugin Plugin = new Plugin
        {
            ...
            version = "1.0",
            url = "https://github.com/dkdue/WindowsGSM.Citadel", // Github repository link (Best practice)
            color = "#34c9eb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "489650"; // Game server appId, Citadel 489650

        // - Standard Constructor and properties
        public Citadel(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        ...
        public string Defaultmap = "TheWorld"; // Default map name
        ...
        {
            string configPath = Functions.ServerPath.GetServersServerFiles(_serverData.ServerID, @"Citadel\Saved\Config\WindowsServer\Game.ini");
        ...
        public async Task<Process> Start()
        {
            ...
            string win64 = Path.Combine(ServerPath.GetServersServerFiles(_serverData.ServerID, @"Citadel\Binaries\Win64\"));
